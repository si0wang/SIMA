...
class CHAIR(object):
    ...
    def __init__(self, imids, coco_path):
        ...
        #read in synonyms
        synonyms = open('/export/jchen169/xywang/POVID-main/playground/data/eval/Hallucination/data/synonyms.txt').readlines()
    ...
    def caption_to_words(self, caption):
        ...
        words = [lemma.lemmatize(w, pos='n') for w in words]
...
if __name__ == '__main__':
    ...
    parser.add_argument("--cap_file", type=str, default='/export/jchen169/xywang/POVID-main/playground/data/eval/Hallucination/answers/sampled5k_val2014/gap_filling_lora_v1_epoch1_la256.json')
    parser.add_argument("--annotation_path", type=str, default='/export/jchen169/xywang/POVID-main/playground/data/eval/Hallucination/annotations/annotations')
    ...
    save_hallucinated_words('short_llama_adapter_word.json', cap_dict)
